...
<div id="wrapper">
	...
	<div id="menu">
		<ul>
			...
			<?php				
				if(isset($_SESSION['auth'])) echo '<li><a href="/sportraining/deconnexion">Se deconnecter</a></li>';
				else echo '<li><a href="/sportraining/connexion">Se connecter</a></li>';
			?>
			...
			<?php				
				if(isset($_SESSION['auth'])) echo '<li><a> S\'enregistrer</a></li>' ;
				else echo '<li><a href="/sportraining/adduser">S\'enregistrer</a></li>';
			?>
	...
	<div id="sidebar">
		<div id="feed">
			...
			<?php				
				if(isset($_SESSION['auth'])) echo '	<a class="user_connect" href="/sportraining/moncompte"> Bonjour '. ucfirst($_SESSION['auth']['prenom']) .'</a>';
