...
<table width ="90%">
    ...
    <form  method="post" id="form1" action="stats">
        <tr valign="top"><td width="40%" >
            ...
            <select class="input-medium" name="sport" id="sport">
<?php
...
while ($donnees = mysql_fetch_assoc($reponse)) {
    ?>
        ...
        <p>
            ...
            <label><i>Annee</i></label>
            <select class="input-medium" name="annee" id="annee" onchange="corresp_mois_jour(document.getElementById('mois').value,this.value)">
...
while ($donnees = mysql_fetch_assoc($reponse)) {
    ...
    for ($i = $y1; $i <= $y2; $i++) {
        ?>
            ...
            <label><i>Mois</i></label>

            <select class="input-medium" name="mois" id="mois" onchange="corresp_mois_jour(this.value,document.getElementById('annee').value)">
...
for ($i = 0; $i <= 11; $i++) {
    ?>
            ...
            <label><i>Jour</i></label>
            <select class="input-medium" name="jour" id="jour">
...
?>
            ...
            <br>
            <br>
            <label><b>Regroupe par</b></label>
            <select class="input-medium" name="regroup" id="regroup">
            ...
            <label><b>Max</b></label>
            <label><i>Annee</i></label>
            <select class="input-medium" name="annee1" id="annee1" onchange="corresp_mois1_jour1(document.getElementById('mois1').value,this.value)">
...
while ($donnees = mysql_fetch_assoc($reponse)) {
    ...
    for ($i = $y1; $i <= $y2; $i++) {
        ?>
            ...
            <label><i>Mois</i></label>
            <select class="input-medium" name="mois1" id="mois1" onchange="corresp_mois1_jour1(this.value,document.getElementById('annee1').value)">
                <?php
                $months = array('Janvier', 'Fevrier', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Aout', 'Septembre', 'Octobre', 'Novembre', 'Decembre');
...
?>
            ...
            <label><i>Jour</i></label>
            <select class="input-medium" name="jour1" id="jour1">
                <?php
                for ($i = 1; $i <= 31; $i++) {
                    ?>
                    <option value="<?php echo $i; ?>"><?php echo $i; ?></option>
        ...
        <p>
            <label><b>Ordonnee</b></label>
            <select class="input-medium" name="ordonnee" id="ordonnee">
