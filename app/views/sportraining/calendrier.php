 ...
 * calendrier.php
 * 
 * Copyright 2012 Clément <Cl�ment@CL�MENT-PC>
 * 
...
?>
<!-- Lien au fichier CSS sp�cifique du calendrier -->
...
<!-- V�rification qu'une session existe et que l'utilisateur est connect� -->
	...
	?>
		...
		<table>
			...
			<tr>
				...
				<td>
					 <h5>Difficult�s : <?php echo htmlspecialchars($donnees['Difficulte']);?></h5>
				</td>
			</tr>
						<tr>
				<td>
		...
		if ($compteur!=1 and $compteur != $_SESSION['nb']+1) :
			echo '<a id = "entrainementLink'.($compteur-1).'" ><img src="/static/images/previousButton.png" style="position : relative; top : 9px; margin-right : 8px;" > Entrainement Pr�cedent </a>';
